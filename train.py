...
from transformers import AutoTokenizer, AutoModelForQuestionAnswering, LongformerForQuestionAnswering
import transformers
...
import collections
# py -m pip install datasets transformers
# py -m pip install torch==1.8.1+cu111 torchvision==0.9.1+cu111 torchaudio===0.8.1 -f https://download.pytorch.org/whl/torch_stable.html
# py -m pip install flask-ngrok
